package custom::apps::vmware::nsx_controller::mode::ntp;
...
sub run {
    ...
    my $synctime = $data->{syncTime};

    $self->{output}->output_add(severity => "OK",
                                short_msg => sprintf("Uptime : %ss", $synctime));
...
Check VMWare NSX Controller NTP.
